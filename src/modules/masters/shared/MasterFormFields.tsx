...
export interface MasterFormFieldConfig<TFormValues extends FieldValues> {
...
interface MasterFormFieldsProps<TFormValues extends FieldValues> {
  form: UseFormReturn<TFormValues>;
  fields: Array<MasterFormFieldConfig<TFormValues>>;
}

export function MasterFormFields<TFormValues extends FieldValues>({
  form,
  fields,
}: MasterFormFieldsProps<TFormValues>) {
  return (
    <>
      {fields.map((field) => {
        const errorMessage = (
